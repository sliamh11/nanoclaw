...
| [pattern-verification-system.md](pattern-verification-system.md) | patterns / verification / drift | 6-mode check system for pattern files — static + LLM-behavioral verification catching all 6 categories of content and routing gaps |
